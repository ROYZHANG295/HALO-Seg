...
model = dict(
    ...
    decode_head=dict(
        ...
        in_channels=128,
        channels=64,
        # HALO uses this to split training stages based on total iterations.
        max_iters=7800,  
        dropout_ratio=0.0,
        num_classes=11,
        align_corners=False,
...
load_from = './experiments/halo-ddrnet_23-slim_in1k-pre-halo_avg3-opt_1xb12-120k_cityscapes-1024x1024_dia543_dd100501_fb05-78.23/best_mIoU_iter_120000.pth' 
resume = None
